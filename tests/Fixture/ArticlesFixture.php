...
class ArticlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_articles_created_by' => ['type' => 'index', 'columns' => ['created_by'], 'length' => []],
            'fk_articles_last_modified_by' => ['type' => 'index', 'columns' => ['last_modified_by'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'slug' => ['type' => 'unique', 'columns' => ['slug'], 'length' => []],
            'fk_articles_created_by' => ['type' => 'foreign', 'columns' => ['created_by'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'fk_articles_last_modified_by' => ['type' => 'foreign', 'columns' => ['last_modified_by'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'published' => 1,
            'created_on' => '2018-03-29 16:51:03',
            'last_modified_on' => '2018-03-29 16:51:03',
            'created_by' => 1,
            'last_modified_by' => 1
        ],
    ];
