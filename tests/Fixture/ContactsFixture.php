...
class ContactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'subject' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'message' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'read' => 1,
            'created_on' => '2018-03-29 16:51:31'
        ],
    ];
}
