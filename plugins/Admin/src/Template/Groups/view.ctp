...
<div class="groups view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $this->Number->format($group->last_modified_by) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Created On') ?></th>
            <td><?= h($group->created_on) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Last Modified On') ?></th>
            <td><?= h($group->last_modified_on) ?></td>
        </tr>
        <tr>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td><?= h($users->last_modified_on) ?></td>
                <td><?= h($users->created_by) ?></td>
                <td><?= h($users->last_modified_by) ?></td>
                <td class="actions">
