...
class GroupsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_groups_created_by' => ['type' => 'index', 'columns' => ['created_by'], 'length' => []],
            'fk_groups_last_modified_by' => ['type' => 'index', 'columns' => ['last_modified_by'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_groups_created_by' => ['type' => 'foreign', 'columns' => ['created_by'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'fk_groups_last_modified_by' => ['type' => 'foreign', 'columns' => ['last_modified_by'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'active' => 1,
            'created_on' => '2018-03-15 16:36:43',
            'last_modified_on' => '2018-03-15 16:36:43',
            'created_by' => 1,
            'last_modified_by' => 1
        ],
    ];
